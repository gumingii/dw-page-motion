$(function(){ 
    ...
    $('.dw_detail_inner').mouseenter(function(){
        ...
        if(windowWidth > 1300) {
            $('.detail_img2').attr('style', "margin-right:-6px;");
        }
...
//    $('.main_img .content h2').addClass('fadein');
    ...
    $(window).scroll(function(){
        ...
        scroll_animation('#classic img', thisPage, 'watch_up');
        scroll_animation('#iconic .boxs img', thisPage, 'watch_up');
        scroll_animation('#petite img', thisPage, 'watch_up');
    });
